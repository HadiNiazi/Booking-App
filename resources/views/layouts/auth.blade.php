    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="{{ route('dashboard') }}" style="text-decoration: none; color: #ecf0ef">
                {{-- <img src="{{ Vite::asset('resources/assets/images/logo.svg') }}" alt="logo" /> --}}
                <span>{{ config('app.name') }}</span>
            </a>
          <a class="sidebar-brand brand-logo-mini" href="{{ route('dashboard') }}" style="text-decoration: none; color: #ecf0ef">
            {{-- <img src="{{ Vite::asset('resources/assets/images/logo-mini.svg') }}" alt="logo" /> --}}
            <span>BK</span>
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items {{ request()->routeIs('events.index') || request()->routeIs('events.create') || request()->routeIs('events.show') || request()->routeIs('events.edit') ? 'active': '' }}">
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block"><b style="font-size: 18px">Hadayat Niazi</b></span>
